...
namespace Core.VFX
{
    // Added to projectiles and area effects to Start/Clear persistent VFXs that are attached to the entities.
    public sealed class AttachedVFXController : MonoBehaviour, IPoolableVisual
    {

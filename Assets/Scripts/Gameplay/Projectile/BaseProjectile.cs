...
using Gameplay.Projectile.Impact;
using Gameplay.VFX;
using Interfaces;
using UnityEngine;
...
namespace Gameplay.Projectile
{
    public class BaseProjectile : MonoBehaviour
    {
        ...
        [Header("VFX")]
        //[SerializeField] protected GameObject impactVFXPrefab;      // TODO: This will no longer be here, but inside the AttackData
        ...
        private void OnTriggerEnter2D(Collider2D other)
        {
            ...
            var payload = new DamagePayload(
                hitData: attackProperties, //impactBehavior.GetDamage(_context),        // TODO: In case of damage multipliers, should apply before this.
                hitPoint: hitPoint,
                source: _damageSource
            );
            
            // Trigger OnImpact results
            impactBehavior?.OnImpact(gameObject, other, payload);
            
            _remainingHits--;
        
            // NOTE: This is now handled by the Damageable component/OnImpact receiver.
            // Spawn the VFX BEFORE deactivation
            //SpawnImpactVFX(hitPoint);
        
            // Note: Deprecated, now only return to pool after reaching the max range.
        ...
        private IObjectPool<BaseProjectile> _objectPool;
        private bool _isReleased;
        public void AssignToPool(IObjectPool<BaseProjectile> objectPool) => _objectPool = objectPool;    
